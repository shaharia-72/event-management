...
class AdminApprovalRequestAdmin(admin.ModelAdmin):
    list_display = ('organization', 'tag', 'is_approved', 'created_at')
...
class ConversationHallPostAdmin(PostAdmin):
    list_display = ('title', 'organization', 'hall_category', 'price_per_hour')
...
admin.site.register(AdminApprovalRequest, AdminApprovalRequestAdmin)
